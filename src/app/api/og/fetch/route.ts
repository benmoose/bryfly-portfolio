...
async function extractMetadata (html: string) {
  ...
  const descMatch = (html.match(/<meta[^>]*name="description"[^>]*content="([^"]+)"[^>]*>/i) != null) ||
    (html.match(/<meta[^>]*content="([^"]+)"[^>]*name="description"[^>]*>/i) != null) ||
    html.match(/<meta[^>]*property="og:description"[^>]*content="([^"]+)"[^>]*>/i)
  const imageMatch = (html.match(/<meta[^>]*property="og:image"[^>]*content="([^"]+)"[^>]*>/i) != null) ||
